...
'			Me.Load += New System.EventHandler(Me.Form1_Load);
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			...
			Next i
			dt.Rows.Add(New Object() {"QUEEN", 5, DateTime.Today.AddDays(-10), DateTime.Today.AddDays(3), DateTime.Today.AddDays(-1), 3, 23.0D, "Vins et alcools Chevalier", "59 rue de l'Abbaye", "Reims", "", "51100", "France", DateTime.Now.AddDays(-1) })
